...
import { ArrowUpRight, Clock, EnvelopeSimple, MapPin, Phone, WhatsappLogo } from "@phosphor-icons/react/dist/ssr";
...
const channels = [
  { label: "Téléphone du cabinet", value: site.phones.landline.display, href: site.phones.landline.href, Icon: Phone },
  { label: "Mobile", value: site.phones.mobile.display, href: site.phones.mobile.href, Icon: Phone },
  { label: "WhatsApp", value: "Écrire au cabinet", href: site.whatsapp, Icon: WhatsappLogo, external: true },
  { label: "E-mail", value: site.email, href: `mailto:${site.email}`, Icon: EnvelopeSimple },
];
      ...
      <section className="mx-auto max-w-[1400px] px-4 pb-24 md:px-8 md:pb-32">
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-12">
          <Reveal blur={false} className="lg:col-span-8">
            <div id="rendez-vous" className="scroll-mt-28 rounded-[2.25rem] bg-ink/[0.03] p-1.5 ring-1 ring-line">
              <div className="rounded-[calc(2.25rem-0.375rem)] bg-elevated p-7 md:p-12">
          ...
          <div className="flex flex-col gap-5 lg:col-span-4">
            <Reveal blur={false} delay={0.08}>
              <ul className="rounded-[2.25rem] bg-ink/[0.03] p-1.5 ring-1 ring-line">
                <li className="rounded-[calc(2.25rem-0.375rem)] bg-noir p-7 text-noir-ink md:p-8">
                  <ul className="divide-y divide-white/10">
                    {channels.map(({ label, value, href, Icon, external }) => (
                      <li key={label}>
                        ...
                        >
                          <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white/[0.06] text-[#e4c68a] ring-1 ring-white/10">
                          ...
                          <ArrowUpRight size={16} weight="light" className="text-white/40 transition-transform duration-500 ease-luxe group-hover:-translate-y-px group-hover:translate-x-0.5 group-hover:text-[#e4c68a]" />
                        </a>
                      </li>
                    ))}
                  </ul>
            ...
            <Reveal blur={false} delay={0.14}>
              <div className="rounded-[2.25rem] bg-ink/[0.03] p-1.5 ring-1 ring-line">
                <div className="rounded-[calc(2.25rem-0.375rem)] bg-elevated p-7 md:p-8">
                  <div className="flex gap-4">
                    <MapPin size={22} weight="light" className="mt-0.5 shrink-0 text-gold-ink" />
                  ...
                  <div className="mt-5 flex gap-4 text-ink-soft">
                    <Clock size={22} weight="light" className="mt-0.5 shrink-0 text-gold-ink" />
                    <p>{site.hours}</p>
                  </div>
                  <a
                    href={site.mapsUrl}
                  ...
                  >
                    Ouvrir dans Google Maps <ArrowUpRight size={14} weight="light" />
                  </a>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal blur={false} delay={0.2} className="hidden lg:block">
              <div className="rounded-[2.25rem] bg-ink/[0.03] p-1.5 ring-1 ring-line">
                <div className="relative aspect-[4/3] overflow-hidden rounded-[calc(2.25rem-0.375rem)]">
        ...
        <Reveal blur={false} className="mt-5">
          <div className="rounded-[2.25rem] bg-ink/[0.03] p-1.5 ring-1 ring-line">
            <div className="relative aspect-[4/3] overflow-hidden rounded-[calc(2.25rem-0.375rem)] md:aspect-[21/8]">
              <iframe
