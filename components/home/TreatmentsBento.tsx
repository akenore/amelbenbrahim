...
import { ArrowUpRightIcon, PlantIcon } from "@phosphor-icons/react/dist/ssr";
...
const cells: { slug: string; tone: Tone; span: string; minH: string; photo?: Photo }[] = [
  { slug: "aligneurs-invisibles", tone: "photo", span: "lg:col-span-7 lg:row-span-2", minH: "min-h-110 lg:min-h-160", photo: stock.alignerFit },
  { slug: "orthodontie-linguale", tone: "noir", span: "lg:col-span-5", minH: "min-h-75" },
  { slug: "bagues-ceramique-metal", tone: "photo", span: "lg:col-span-5", minH: "min-h-80", photo: photos.doctorChair },
  { slug: "orthodontie-enfant", tone: "tint", span: "lg:col-span-4", minH: "min-h-80" },
  { slug: "orthodontie-adulte", tone: "photo", span: "lg:col-span-5", minH: "min-h-80", photo: stock.adult },
  { slug: "contention", tone: "plain", span: "lg:col-span-3", minH: "min-h-80" },
];
...
function Cell({ t, tone, photo }: { t: Treatment; tone: Tone; photo?: Photo }) {
  ...
  return (
    ...
    >
      ...
      {tone === "tint" && (
        <PlantIcon size={120} weight="thin" className="absolute right-6 top-6 text-gold-ink opacity-50" aria-hidden />
      )}
