...
export function FaqSection() {
  return (
    <section aria-labelledby="faq-titre" className="mx-auto max-w-[1400px] px-4 py-24 md:px-8 md:py-36">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            <Reveal blur={false} className="mt-10 hidden lg:block">
              <div className="rounded-[2rem] bg-ink/[0.03] p-1.5 ring-1 ring-line">
                <div className="relative aspect-[3/2] overflow-hidden rounded-[calc(2rem-0.375rem)]">
